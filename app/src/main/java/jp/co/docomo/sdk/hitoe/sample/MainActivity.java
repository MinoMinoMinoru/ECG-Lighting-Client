...
//    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("In Main onCreate",URL);
        Log.d("In Main onCreate",NAME);
        client.setIp(URL);

        Toast.makeText(MainActivity.this, "URL:"+URL+"- Name:" + NAME, Toast.LENGTH_LONG).show();
        ...
        public void onDataReceive(String connectionId, int response_id, String dataKey, String rawData) throws RemoteException {
            ...
            try {
                ...
                if (dataKey.equals("raw.ecg")) {
                    ...
                    Log.d("RRIログ ALL",rawData);
                    for (int i=0;i<split.length;i++){
                        String[] RRI = split[i].split(CommonConsts.COMMA, -1);
                        Log.d("RRIログ",i+":"+split[i]);
                        Log.d("RRIログ","RRI[0]:"+RRI[0]);
                        Log.d("RRIログ","RRI[1]:"+RRI[1]);
                        client.post(NAME,Integer.valueOf(RRI[1]));
                    }
